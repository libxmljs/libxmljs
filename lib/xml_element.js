...
bindings.Element.Arguments = function(args) {
  var ret_args = null;
...
bindings.Element.prototype.node = function() {
  var args = bindings.Element.Arguments(arguments);
  var elem = null;

  if (args[0] instanceof bindings.Element)
    elem = args[0];
  else
    elem = new bindings.Element(this.doc(), args[0], args[1], args[2], args[3]);

  this.addChild(elem);
  return elem;
};

bindings.Element.prototype.get = function() {
  return this.find.apply(this, arguments)[0];
};

bindings.Element.prototype.defineNamespace = function() {
  var args = arguments.length == 1 ? [null, arguments[0]] : [arguments[0], arguments[1]];
  return new bindings.Namespace(this, args[0], args[1]);
};
