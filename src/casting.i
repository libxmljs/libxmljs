%header %{
    static SwigV8ReturnValue xmlPtrToXmlNode(const SwigV8Arguments &args) {
        ...
        checkParentRef(node, xmlNodeGetParent(node), 1);
...
%init %{
    SWIGV8_AddStaticFunction(exports_obj, "xmlPtrToXmlNode", xmlPtrToXmlNode);
    SWIGV8_AddStaticFunction(exports_obj, "xmlPtrToXmlDoc", xmlPtrToXmlDoc);
    SWIGV8_AddStaticFunction(exports_obj, "xmlPtrToXmlAttr", xmlPtrToXmlAttr);
    SWIGV8_AddStaticFunction(exports_obj, "xmlPtrToXmlElement", xmlPtrToXmlElement);
    SWIGV8_AddStaticFunction(exports_obj, "xmlPtrToXmlDtd", xmlPtrToXmlDtd);
    SWIGV8_AddStaticFunction(exports_obj, "xmlPtrToXmlNs", xmlPtrToXmlNs);
%}